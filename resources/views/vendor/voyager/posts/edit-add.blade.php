                ...
                <div class="col-md-4">
                    ...
                    <div class="panel panel-bordered panel-info">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="form-group">
                                <label for="seo_title">og_title</label>
                                @include('voyager::multilingual.input-hidden', [
                                    '_field_name'  => 'og_title',
                                    '_field_trans' => get_field_translations($dataTypeContent, 'og_title')
                                ])
                                <input type="text" class="form-control" name="og_title" placeholder="OG Title" value="{{ $dataTypeContent->og_title ?? '' }}">
                            </div>
                            <div class="form-group">
                                <label for="seo_title">Og description</label>
                                @include('voyager::multilingual.input-hidden', [
                                    '_field_name'  => 'og_description',
                                    '_field_trans' => get_field_translations($dataTypeContent, 'og_description')
                                ])
                                <input type="text" class="form-control" name="og_description" placeholder="OG Description" value="{{ $dataTypeContent->og_description ?? '' }}">
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <script>
        $(document).ready(function(){
            ...
            tinymce.init({
                ...
                toolbar: 'styleselect bold italic underline | forecolor backcolor | alignleft aligncenter alignright | bullist numlist outdent indent | link | code',
                convert_urls: false,
                image_caption: true,
                image_title: true,
